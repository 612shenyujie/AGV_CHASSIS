...
typedef uint8_t BUZZER_BEEP_TASK_TO_PRIORITY_LUT_T; enum 
{
	...
	BUZZER_MOTION_MOTOR_OFFLINE_PRIORITY	=	3,
	BUZZER_DIRECTIVE_MOTOR_OFFLINE_PRIORITY	=	4,
	BUZZER_ENCODER_OFFLINE_PRIORITY	=	5,
	BUZZER_CALIBRATING_PRIORITY		= 6,
	BUZZER_CALIBRATED_PRIORITY		= 7, 
...
//	规定动力电机离线声音
typedef uint16_t BUZZER_DEVICE_MOTION_MOTOR_OFFLINE_TICK_TO_TONE_LUT_T; enum
{
	BUZZER_DEVICE_MOTION_MOTOR_OFFLINE_STEP1_PLAY_TONE_D4 = 0,
	BUZZER_DEVICE_MOTION_MOTOR_OFFLINE_STEP2_PLAY_TONE_D_SLASH_4 = 300,
	BUZZER_DEVICE_MOTION_MOTOR_OFFLINE_STEP3_BUZZER_SWITCH_OFF = 600,
	BUZZER_DEVICE_MOTION_MOTOR_OFFLINE_STEP4_BUZZER_RELEASE = 1000,
};

//	规定转向电机离线声音
typedef uint16_t BUZZER_DEVICE_DIRECTIVE_MOTOR_OFFLINE_TICK_TO_TONE_LUT_T; enum
{
	BUZZER_DEVICE_DIRECTIVE_MOTOR_OFFLINE_STEP1_PLAY_TONE_F4 = 0,
	BUZZER_DEVICE_DIRECTIVE_MOTOR_OFFLINE_STEP2_PLAY_TONE_F_SLASH_4 = 300,
	BUZZER_DEVICE_DIRECTIVE_MOTOR_OFFLINE_STEP3_BUZZER_SWITCH_OFF = 600,
	BUZZER_DEVICE_DIRECTIVE_MOTOR_OFFLINE_STEP4_BUZZER_RELEASE = 1000,
};

typedef uint16_t BUZZER_DEVICE_ENCODER_OFFLINE_TICK_TO_TONE_LUT_T; enum
{
	BUZZER_DEVICE_ENCODER_OFFLINE_STEP1_PLAY_TONE_G5 = 0,
	BUZZER_DEVICE_ENCODER_OFFLINE_STEP2_PLAY_TONE_G_SLASH_5 = 300,
	BUZZER_DEVICE_ENCODER_OFFLINE_STEP3_BUZZER_SWITCH_OFF = 600,
	BUZZER_DEVICE_ENCODER_OFFLINE_STEP4_BUZZER_RELEASE = 1000,
};
